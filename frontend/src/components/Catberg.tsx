...
export default function Catberg() {
  ...
  return (
    <div ref={containerRef} className="w-full h-64 flex flex-col bg-[#05080a] text-green font-mono text-[11px] border-t border-green/20 flex-shrink-0 relative overflow-hidden" style={{ fontFamily: '"JetBrains Mono", "Fira Code", monospace' }}>
      {/* Ticker Bar */}
