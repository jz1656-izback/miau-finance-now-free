...
export const data_privacy_gdpr_finance: Course = {
  id: 'data-privacy-gdpr-finance', slug: 'data-privacy-gdpr-finance', title: 'Data Privacy & GDPR in Finance',
  description: 'A cat-guided professional development course on Data Privacy & GDPR in Finance. Sharpen your skills.',
  category: 'Security', difficulty: 'intermediate', icon: '💼', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'data-privacy-gdpr-finance-1', slug: 'data-privacy-gdpr-finance-1', title: 'Fundamentals', description: 'Core principles of Data Privacy & GDPR in Finance.', commands: ['help'], steps: [
      { instruction: 'Learn the fundamentals of Data Privacy & GDPR in Finance.' },
    ...
    { id: 'data-privacy-gdpr-finance-2', slug: 'data-privacy-gdpr-finance-2', title: 'Practical Application', description: 'Applying these skills.', commands: ['help'], steps: [
    ...
    { id: 'data-privacy-gdpr-finance-3', slug: 'data-privacy-gdpr-finance-3', title: 'Mastery', description: 'Advanced techniques.', commands: ['help'], steps: [
      { instruction: 'Master advanced techniques in Data Privacy & GDPR in Finance.' },
