...
export const caribbean_offshore_finance: Course = {
  id: 'caribbean-offshore-finance', slug: 'caribbean-offshore-finance', title: 'Caribbean & Offshore Finance',
  description: 'Explore Caribbean & Offshore Finance — the cat travels the world one market at a time.',
  category: 'Global Markets', difficulty: 'intermediate', icon: '🌍', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'caribbean-offshore-finance-1', slug: 'caribbean-offshore-finance-1', title: 'Market Overview', description: 'Understanding Caribbean & Offshore Finance.', commands: ['global'], steps: [
      { instruction: 'Explore Caribbean & Offshore Finance using the global markets command.' },
    ...
    { id: 'caribbean-offshore-finance-2', slug: 'caribbean-offshore-finance-2', title: 'Trading Mechanics', description: 'How to trade in this market.', commands: ['global'], steps: [
    ...
    { id: 'caribbean-offshore-finance-3', slug: 'caribbean-offshore-finance-3', title: 'Investment Opportunities', description: 'Opportunities in Caribbean & Offshore Finance.', commands: ['help'], steps: [
