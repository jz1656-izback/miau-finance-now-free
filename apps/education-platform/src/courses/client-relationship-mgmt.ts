...
export const client_relationship_mgmt: Course = {
  id: 'client-relationship-mgmt', slug: 'client-relationship-mgmt', title: 'Client Relationship Management',
  description: 'A cat-guided professional development course on Client Relationship Management. Sharpen your skills.',
  category: 'Career Development', difficulty: 'intermediate', icon: '💼', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'client-relationship-mgmt-1', slug: 'client-relationship-mgmt-1', title: 'Fundamentals', description: 'Core principles of Client Relationship Management.', commands: ['help'], steps: [
      { instruction: 'Learn the fundamentals of Client Relationship Management.' },
    ...
    { id: 'client-relationship-mgmt-2', slug: 'client-relationship-mgmt-2', title: 'Practical Application', description: 'Applying these skills.', commands: ['help'], steps: [
    ...
    { id: 'client-relationship-mgmt-3', slug: 'client-relationship-mgmt-3', title: 'Mastery', description: 'Advanced techniques.', commands: ['help'], steps: [
      { instruction: 'Master advanced techniques in Client Relationship Management.' },
