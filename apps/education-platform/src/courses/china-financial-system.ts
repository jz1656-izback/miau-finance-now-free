...
export const china_financial_system: Course = {
  id: 'china-financial-system', slug: 'china-financial-system', title: 'China Financial System',
  description: 'Explore China Financial System — the cat travels the world one market at a time.',
  category: 'Global Markets', difficulty: 'intermediate', icon: '🌍', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'china-financial-system-1', slug: 'china-financial-system-1', title: 'Market Overview', description: 'Understanding China Financial System.', commands: ['global'], steps: [
      { instruction: 'Explore China Financial System using the global markets command.' },
    ...
    { id: 'china-financial-system-2', slug: 'china-financial-system-2', title: 'Trading Mechanics', description: 'How to trade in this market.', commands: ['global'], steps: [
    ...
    { id: 'china-financial-system-3', slug: 'china-financial-system-3', title: 'Investment Opportunities', description: 'Opportunities in China Financial System.', commands: ['help'], steps: [
