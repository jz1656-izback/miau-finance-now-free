...
export const middle_east_markets: Course = {
  id: 'middle-east-markets', slug: 'middle-east-markets', title: 'Middle East Markets',
  description: 'Explore Middle East Markets — the cat travels the world one market at a time.',
  category: 'Global Markets', difficulty: 'intermediate', icon: '🌍', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'middle-east-markets-1', slug: 'middle-east-markets-1', title: 'Market Overview', description: 'Understanding Middle East Markets.', commands: ['global'], steps: [
      { instruction: 'Explore Middle East Markets using the global markets command.' },
    ...
    { id: 'middle-east-markets-2', slug: 'middle-east-markets-2', title: 'Trading Mechanics', description: 'How to trade in this market.', commands: ['global'], steps: [
    ...
    { id: 'middle-east-markets-3', slug: 'middle-east-markets-3', title: 'Investment Opportunities', description: 'Opportunities in Middle East Markets.', commands: ['help'], steps: [
