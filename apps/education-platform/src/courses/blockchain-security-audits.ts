...
export const blockchain_security_audits: Course = {
  id: 'blockchain-security-audits', slug: 'blockchain-security-audits', title: 'Blockchain Security Audits',
  description: 'A cat-friendly guide to Blockchain Security Audits. The cat explores Web3 one paw at a time.',
  category: 'Security', difficulty: 'advanced', icon: '🔗', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'blockchain-security-audits-1', slug: 'blockchain-security-audits-1', title: 'Core Concepts', description: 'Understanding Blockchain Security Audits.', commands: ['defi protocols'], steps: [
      { instruction: 'Learn the fundamentals of Blockchain Security Audits.' },
    ...
    { id: 'blockchain-security-audits-2', slug: 'blockchain-security-audits-2', title: 'Practical Applications', description: 'Using Blockchain Security Audits in practice.', commands: ['gas 1'], steps: [
    ...
    { id: 'blockchain-security-audits-3', slug: 'blockchain-security-audits-3', title: 'Security Best Practices', description: 'Staying safe.', commands: ['gas 1'], steps: [
