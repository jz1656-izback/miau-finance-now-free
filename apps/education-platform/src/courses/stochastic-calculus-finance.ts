...
export const stochastic_calculus_finance: Course = {
  id: 'stochastic-calculus-finance', slug: 'stochastic-calculus-finance', title: 'Stochastic Calculus for Finance',
  description: 'A comprehensive cat-themed course on Stochastic Calculus for Finance.',
  category: 'Quantitative', difficulty: 'intermediate', icon: '📘', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'stochastic-calculus-finance-1', slug: 'stochastic-calculus-finance-1', title: 'Overview', description: 'Introduction to Stochastic Calculus for Finance.', commands: ['help'],
      steps: [{ instruction: 'Learn the fundamentals of Stochastic Calculus for Finance.' },
    ...
    { id: 'stochastic-calculus-finance-2', slug: 'stochastic-calculus-finance-2', title: 'Core Concepts', description: 'Key ideas.', commands: ['help'],
      steps: [{ instruction: 'Explore the core concepts of Stochastic Calculus for Finance.' },
    ...
    { id: 'stochastic-calculus-finance-3', slug: 'stochastic-calculus-finance-3', title: 'Practical Use', description: 'Real-world application.', commands: ['help'],
