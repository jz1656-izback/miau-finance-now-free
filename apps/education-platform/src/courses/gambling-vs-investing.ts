...
export const gambling_vs_investing: Course = {
  id: 'gambling-vs-investing', slug: 'gambling-vs-investing', title: 'Gambling vs Investing',
  description: 'A comprehensive cat-themed course on Gambling vs Investing.',
  category: 'Literacy', difficulty: 'intermediate', icon: '📘', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'gambling-vs-investing-1', slug: 'gambling-vs-investing-1', title: 'Overview', description: 'Introduction to Gambling vs Investing.', commands: ['help'],
      steps: [{ instruction: 'Learn the fundamentals of Gambling vs Investing.' },
    ...
    { id: 'gambling-vs-investing-2', slug: 'gambling-vs-investing-2', title: 'Core Concepts', description: 'Key ideas.', commands: ['help'],
      steps: [{ instruction: 'Explore the core concepts of Gambling vs Investing.' },
    ...
    { id: 'gambling-vs-investing-3', slug: 'gambling-vs-investing-3', title: 'Practical Use', description: 'Real-world application.', commands: ['help'],
