...
export const mining_resources_finance: Course = {
  id: 'mining-resources-finance', slug: 'mining-resources-finance', title: 'Mining & Resources Finance',
  description: 'A comprehensive cat-themed guide to Mining & Resources Finance. Learn how to analyze and invest in this sector.',
  category: 'Industry Analysis', difficulty: 'intermediate', icon: '📘', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'mining-resources-finance-1', slug: 'mining-resources-finance-1', title: 'Sector Overview', description: 'Understanding the Mining & Resources Finance sector.',
      commands: ['help'], steps: [
        { instruction: 'Explore the Mining & Resources Finance sector and its key players.' },
    ...
    { id: 'mining-resources-finance-2', slug: 'mining-resources-finance-2', title: 'Key Metrics', description: 'Important metrics for Mining & Resources Finance.',
      commands: ['help'], steps: [
    ...
    { id: 'mining-resources-finance-3', slug: 'mining-resources-finance-3', title: 'Investment Strategies', description: 'Strategies for Mining & Resources Finance investing.',
      commands: ['help'], steps: [
