...
export const global_macro_hedging: Course = {
  id: 'global-macro-hedging', slug: 'global-macro-hedging', title: 'Global Macro Hedging',
  description: 'Explore Global Macro Hedging — the cat travels the world one market at a time.',
  category: 'Macro', difficulty: 'intermediate', icon: '🌍', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'global-macro-hedging-1', slug: 'global-macro-hedging-1', title: 'Market Overview', description: 'Understanding Global Macro Hedging.', commands: ['global'], steps: [
      { instruction: 'Explore Global Macro Hedging using the global markets command.' },
    ...
    { id: 'global-macro-hedging-2', slug: 'global-macro-hedging-2', title: 'Trading Mechanics', description: 'How to trade in this market.', commands: ['global'], steps: [
    ...
    { id: 'global-macro-hedging-3', slug: 'global-macro-hedging-3', title: 'Investment Opportunities', description: 'Opportunities in Global Macro Hedging.', commands: ['help'], steps: [
