...
export const water_infrastructure_finance: Course = {
  id: 'water-infrastructure-finance', slug: 'water-infrastructure-finance', title: 'Water Infrastructure Finance',
  description: 'A comprehensive cat-themed guide to Water Infrastructure Finance. Learn how to analyze and invest in this sector.',
  category: 'ESG', difficulty: 'intermediate', icon: '📘', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'water-infrastructure-finance-1', slug: 'water-infrastructure-finance-1', title: 'Sector Overview', description: 'Understanding the Water Infrastructure Finance sector.',
      commands: ['help'], steps: [
        { instruction: 'Explore the Water Infrastructure Finance sector and its key players.' },
    ...
    { id: 'water-infrastructure-finance-2', slug: 'water-infrastructure-finance-2', title: 'Key Metrics', description: 'Important metrics for Water Infrastructure Finance.',
      commands: ['help'], steps: [
    ...
    { id: 'water-infrastructure-finance-3', slug: 'water-infrastructure-finance-3', title: 'Investment Strategies', description: 'Strategies for Water Infrastructure Finance investing.',
      commands: ['help'], steps: [
