...
export const cloud_architecture_finance: Course = {
  id: 'cloud-architecture-finance', slug: 'cloud-architecture-finance', title: 'Cloud Architecture for Finance',
  description: 'A comprehensive cat-themed course on Cloud Architecture for Finance.',
  category: 'DevOps', difficulty: 'intermediate', icon: '📘', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'cloud-architecture-finance-1', slug: 'cloud-architecture-finance-1', title: 'Overview', description: 'Introduction to Cloud Architecture for Finance.', commands: ['help'],
      steps: [{ instruction: 'Learn the fundamentals of Cloud Architecture for Finance.' },
    ...
    { id: 'cloud-architecture-finance-2', slug: 'cloud-architecture-finance-2', title: 'Core Concepts', description: 'Key ideas.', commands: ['help'],
      steps: [{ instruction: 'Explore the core concepts of Cloud Architecture for Finance.' },
    ...
    { id: 'cloud-architecture-finance-3', slug: 'cloud-architecture-finance-3', title: 'Practical Use', description: 'Real-world application.', commands: ['help'],
