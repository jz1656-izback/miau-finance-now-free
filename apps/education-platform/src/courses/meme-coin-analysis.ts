...
export const meme_coin_analysis: Course = {
  id: 'meme-coin-analysis', slug: 'meme-coin-analysis', title: 'Meme Coin Analysis',
  description: 'A comprehensive cat-themed course on Meme Coin Analysis.',
  category: 'Crypto & Web3', difficulty: 'intermediate', icon: '📘', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'meme-coin-analysis-1', slug: 'meme-coin-analysis-1', title: 'Overview', description: 'Introduction to Meme Coin Analysis.', commands: ['help'],
      steps: [{ instruction: 'Learn the fundamentals of Meme Coin Analysis.' },
    ...
    { id: 'meme-coin-analysis-2', slug: 'meme-coin-analysis-2', title: 'Core Concepts', description: 'Key ideas.', commands: ['help'],
      steps: [{ instruction: 'Explore the core concepts of Meme Coin Analysis.' },
    ...
    { id: 'meme-coin-analysis-3', slug: 'meme-coin-analysis-3', title: 'Practical Use', description: 'Real-world application.', commands: ['help'],
