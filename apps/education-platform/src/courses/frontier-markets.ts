...
export const frontier_markets: Course = {
  id: 'frontier-markets', slug: 'frontier-markets', title: 'Frontier Markets',
  description: 'Explore Frontier Markets — the cat travels the world one market at a time.',
  category: 'Global Markets', difficulty: 'intermediate', icon: '🌍', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'frontier-markets-1', slug: 'frontier-markets-1', title: 'Market Overview', description: 'Understanding Frontier Markets.', commands: ['global'], steps: [
      { instruction: 'Explore Frontier Markets using the global markets command.' },
    ...
    { id: 'frontier-markets-2', slug: 'frontier-markets-2', title: 'Trading Mechanics', description: 'How to trade in this market.', commands: ['global'], steps: [
    ...
    { id: 'frontier-markets-3', slug: 'frontier-markets-3', title: 'Investment Opportunities', description: 'Opportunities in Frontier Markets.', commands: ['help'], steps: [
