...
export const defi_lending_protocols: Course = {
  id: 'defi-lending-protocols', slug: 'defi-lending-protocols', title: 'DeFi Lending Protocols',
  description: 'A cat-friendly guide to DeFi Lending Protocols. The cat explores Web3 one paw at a time.',
  category: 'DeFi', difficulty: 'advanced', icon: '🔗', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'defi-lending-protocols-1', slug: 'defi-lending-protocols-1', title: 'Core Concepts', description: 'Understanding DeFi Lending Protocols.', commands: ['defi protocols'], steps: [
      { instruction: 'Learn the fundamentals of DeFi Lending Protocols.' },
    ...
    { id: 'defi-lending-protocols-2', slug: 'defi-lending-protocols-2', title: 'Practical Applications', description: 'Using DeFi Lending Protocols in practice.', commands: ['gas 1'], steps: [
    ...
    { id: 'defi-lending-protocols-3', slug: 'defi-lending-protocols-3', title: 'Security Best Practices', description: 'Staying safe.', commands: ['gas 1'], steps: [
