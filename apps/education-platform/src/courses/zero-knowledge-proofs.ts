...
export const zero_knowledge_proofs: Course = {
  id: 'zero-knowledge-proofs', slug: 'zero-knowledge-proofs', title: 'Zero Knowledge Proofs',
  description: 'A cat-friendly guide to Zero Knowledge Proofs. The cat explores Web3 one paw at a time.',
  category: 'Web3', difficulty: 'advanced', icon: '🔗', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'zero-knowledge-proofs-1', slug: 'zero-knowledge-proofs-1', title: 'Core Concepts', description: 'Understanding Zero Knowledge Proofs.', commands: ['defi protocols'], steps: [
      { instruction: 'Learn the fundamentals of Zero Knowledge Proofs.' },
    ...
    { id: 'zero-knowledge-proofs-2', slug: 'zero-knowledge-proofs-2', title: 'Practical Applications', description: 'Using Zero Knowledge Proofs in practice.', commands: ['gas 1'], steps: [
    ...
    { id: 'zero-knowledge-proofs-3', slug: 'zero-knowledge-proofs-3', title: 'Security Best Practices', description: 'Staying safe.', commands: ['gas 1'], steps: [
