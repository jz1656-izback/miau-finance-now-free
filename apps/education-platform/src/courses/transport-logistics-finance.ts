...
export const transport_logistics_finance: Course = {
  id: 'transport-logistics-finance', slug: 'transport-logistics-finance', title: 'Transport & Logistics Finance',
  description: 'A comprehensive cat-themed guide to Transport & Logistics Finance. Learn how to analyze and invest in this sector.',
  category: 'Industry Analysis', difficulty: 'intermediate', icon: '📘', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'transport-logistics-finance-1', slug: 'transport-logistics-finance-1', title: 'Sector Overview', description: 'Understanding the Transport & Logistics Finance sector.',
      commands: ['help'], steps: [
        { instruction: 'Explore the Transport & Logistics Finance sector and its key players.' },
    ...
    { id: 'transport-logistics-finance-2', slug: 'transport-logistics-finance-2', title: 'Key Metrics', description: 'Important metrics for Transport & Logistics Finance.',
      commands: ['help'], steps: [
    ...
    { id: 'transport-logistics-finance-3', slug: 'transport-logistics-finance-3', title: 'Investment Strategies', description: 'Strategies for Transport & Logistics Finance investing.',
      commands: ['help'], steps: [
