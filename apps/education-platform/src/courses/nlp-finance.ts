...
export const nlp_finance: Course = {
  id: 'nlp-finance', slug: 'nlp-finance', title: 'Natural Language Processing in Finance',
  description: 'A comprehensive cat-themed course on Natural Language Processing in Finance.',
  category: 'AI', difficulty: 'intermediate', icon: '📘', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'nlp-finance-1', slug: 'nlp-finance-1', title: 'Overview', description: 'Introduction to Natural Language Processing in Finance.', commands: ['help'],
      steps: [{ instruction: 'Learn the fundamentals of Natural Language Processing in Finance.' },
    ...
    { id: 'nlp-finance-2', slug: 'nlp-finance-2', title: 'Core Concepts', description: 'Key ideas.', commands: ['help'],
      steps: [{ instruction: 'Explore the core concepts of Natural Language Processing in Finance.' },
    ...
    { id: 'nlp-finance-3', slug: 'nlp-finance-3', title: 'Practical Use', description: 'Real-world application.', commands: ['help'],
