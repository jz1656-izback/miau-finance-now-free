...
export const oracle_networks: Course = {
  id: 'oracle-networks', slug: 'oracle-networks', title: 'Oracle Networks',
  description: 'A cat-friendly guide to Oracle Networks. The cat explores Web3 one paw at a time.',
  category: 'Web3', difficulty: 'advanced', icon: '🔗', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'oracle-networks-1', slug: 'oracle-networks-1', title: 'Core Concepts', description: 'Understanding Oracle Networks.', commands: ['defi protocols'], steps: [
      { instruction: 'Learn the fundamentals of Oracle Networks.' },
    ...
    { id: 'oracle-networks-2', slug: 'oracle-networks-2', title: 'Practical Applications', description: 'Using Oracle Networks in practice.', commands: ['gas 1'], steps: [
    ...
    { id: 'oracle-networks-3', slug: 'oracle-networks-3', title: 'Security Best Practices', description: 'Staying safe.', commands: ['gas 1'], steps: [
