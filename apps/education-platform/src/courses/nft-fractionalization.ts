...
export const nft_fractionalization: Course = {
  id: 'nft-fractionalization', slug: 'nft-fractionalization', title: 'NFT Fractionalization',
  description: 'A cat-friendly guide to NFT Fractionalization. The cat explores Web3 one paw at a time.',
  category: 'Web3', difficulty: 'advanced', icon: '🔗', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'nft-fractionalization-1', slug: 'nft-fractionalization-1', title: 'Core Concepts', description: 'Understanding NFT Fractionalization.', commands: ['defi protocols'], steps: [
      { instruction: 'Learn the fundamentals of NFT Fractionalization.' },
    ...
    { id: 'nft-fractionalization-2', slug: 'nft-fractionalization-2', title: 'Practical Applications', description: 'Using NFT Fractionalization in practice.', commands: ['gas 1'], steps: [
    ...
    { id: 'nft-fractionalization-3', slug: 'nft-fractionalization-3', title: 'Security Best Practices', description: 'Staying safe.', commands: ['gas 1'], steps: [
