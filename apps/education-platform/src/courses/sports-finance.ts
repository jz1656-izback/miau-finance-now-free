...
export const sports_finance: Course = {
  id: 'sports-finance', slug: 'sports-finance', title: 'Sports Finance',
  description: 'A comprehensive cat-themed guide to Sports Finance. Learn how to analyze and invest in this sector.',
  category: 'Industry Analysis', difficulty: 'intermediate', icon: '📘', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'sports-finance-1', slug: 'sports-finance-1', title: 'Sector Overview', description: 'Understanding the Sports Finance sector.',
      commands: ['help'], steps: [
        { instruction: 'Explore the Sports Finance sector and its key players.' },
    ...
    { id: 'sports-finance-2', slug: 'sports-finance-2', title: 'Key Metrics', description: 'Important metrics for Sports Finance.',
      commands: ['help'], steps: [
    ...
    { id: 'sports-finance-3', slug: 'sports-finance-3', title: 'Investment Strategies', description: 'Strategies for Sports Finance investing.',
      commands: ['help'], steps: [
