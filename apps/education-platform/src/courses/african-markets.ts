...
export const african_markets: Course = {
  id: 'african-markets', slug: 'african-markets', title: 'African Markets',
  description: 'Explore African Markets — the cat travels the world one market at a time.',
  category: 'Global Markets', difficulty: 'intermediate', icon: '🌍', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'african-markets-1', slug: 'african-markets-1', title: 'Market Overview', description: 'Understanding African Markets.', commands: ['global'], steps: [
      { instruction: 'Explore African Markets using the global markets command.' },
    ...
    { id: 'african-markets-2', slug: 'african-markets-2', title: 'Trading Mechanics', description: 'How to trade in this market.', commands: ['global'], steps: [
    ...
    { id: 'african-markets-3', slug: 'african-markets-3', title: 'Investment Opportunities', description: 'Opportunities in African Markets.', commands: ['help'], steps: [
