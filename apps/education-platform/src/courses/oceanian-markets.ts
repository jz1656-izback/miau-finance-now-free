...
export const oceanian_markets: Course = {
  id: 'oceanian-markets', slug: 'oceanian-markets', title: 'Oceanian Markets',
  description: 'Explore Oceanian Markets — the cat travels the world one market at a time.',
  category: 'Global Markets', difficulty: 'intermediate', icon: '🌍', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'oceanian-markets-1', slug: 'oceanian-markets-1', title: 'Market Overview', description: 'Understanding Oceanian Markets.', commands: ['global'], steps: [
      { instruction: 'Explore Oceanian Markets using the global markets command.' },
    ...
    { id: 'oceanian-markets-2', slug: 'oceanian-markets-2', title: 'Trading Mechanics', description: 'How to trade in this market.', commands: ['global'], steps: [
    ...
    { id: 'oceanian-markets-3', slug: 'oceanian-markets-3', title: 'Investment Opportunities', description: 'Opportunities in Oceanian Markets.', commands: ['help'], steps: [
