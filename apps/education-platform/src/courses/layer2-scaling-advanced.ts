...
export const layer2_scaling_advanced: Course = {
  id: 'layer2-scaling-advanced', slug: 'layer2-scaling-advanced', title: 'Advanced Layer 2 Scaling',
  description: 'A cat-friendly guide to Advanced Layer 2 Scaling. The cat explores Web3 one paw at a time.',
  category: 'Web3', difficulty: 'advanced', icon: '🔗', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'layer2-scaling-advanced-1', slug: 'layer2-scaling-advanced-1', title: 'Core Concepts', description: 'Understanding Advanced Layer 2 Scaling.', commands: ['defi protocols'], steps: [
      { instruction: 'Learn the fundamentals of Advanced Layer 2 Scaling.' },
    ...
    { id: 'layer2-scaling-advanced-2', slug: 'layer2-scaling-advanced-2', title: 'Practical Applications', description: 'Using Advanced Layer 2 Scaling in practice.', commands: ['gas 1'], steps: [
    ...
    { id: 'layer2-scaling-advanced-3', slug: 'layer2-scaling-advanced-3', title: 'Security Best Practices', description: 'Staying safe.', commands: ['gas 1'], steps: [
