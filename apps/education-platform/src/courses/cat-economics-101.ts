...
export const cat_economics_101: Course = {
  id: 'cat-economics-101', slug: 'cat-economics-101', title: 'Cat Economics 101',
  description: 'A comprehensive cat-themed course on Cat Economics 101.',
  category: 'Economics', difficulty: 'intermediate', icon: '📘', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'cat-economics-101-1', slug: 'cat-economics-101-1', title: 'Overview', description: 'Introduction to Cat Economics 101.', commands: ['help'],
      steps: [{ instruction: 'Learn the fundamentals of Cat Economics 101.' },
    ...
    { id: 'cat-economics-101-2', slug: 'cat-economics-101-2', title: 'Core Concepts', description: 'Key ideas.', commands: ['help'],
      steps: [{ instruction: 'Explore the core concepts of Cat Economics 101.' },
    ...
    { id: 'cat-economics-101-3', slug: 'cat-economics-101-3', title: 'Practical Use', description: 'Real-world application.', commands: ['help'],
