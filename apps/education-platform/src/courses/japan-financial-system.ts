...
export const japan_financial_system: Course = {
  id: 'japan-financial-system', slug: 'japan-financial-system', title: 'Japan Financial System',
  description: 'Explore Japan Financial System — the cat travels the world one market at a time.',
  category: 'Global Markets', difficulty: 'intermediate', icon: '🌍', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'japan-financial-system-1', slug: 'japan-financial-system-1', title: 'Market Overview', description: 'Understanding Japan Financial System.', commands: ['global'], steps: [
      { instruction: 'Explore Japan Financial System using the global markets command.' },
    ...
    { id: 'japan-financial-system-2', slug: 'japan-financial-system-2', title: 'Trading Mechanics', description: 'How to trade in this market.', commands: ['global'], steps: [
    ...
    { id: 'japan-financial-system-3', slug: 'japan-financial-system-3', title: 'Investment Opportunities', description: 'Opportunities in Japan Financial System.', commands: ['help'], steps: [
