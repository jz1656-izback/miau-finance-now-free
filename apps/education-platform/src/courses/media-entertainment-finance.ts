...
export const media_entertainment_finance: Course = {
  id: 'media-entertainment-finance', slug: 'media-entertainment-finance', title: 'Media & Entertainment Finance',
  description: 'A comprehensive cat-themed guide to Media & Entertainment Finance. Learn how to analyze and invest in this sector.',
  category: 'Industry Analysis', difficulty: 'intermediate', icon: '📘', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'media-entertainment-finance-1', slug: 'media-entertainment-finance-1', title: 'Sector Overview', description: 'Understanding the Media & Entertainment Finance sector.',
      commands: ['help'], steps: [
        { instruction: 'Explore the Media & Entertainment Finance sector and its key players.' },
    ...
    { id: 'media-entertainment-finance-2', slug: 'media-entertainment-finance-2', title: 'Key Metrics', description: 'Important metrics for Media & Entertainment Finance.',
      commands: ['help'], steps: [
    ...
    { id: 'media-entertainment-finance-3', slug: 'media-entertainment-finance-3', title: 'Investment Strategies', description: 'Strategies for Media & Entertainment Finance investing.',
      commands: ['help'], steps: [
