...
export const renewable_energy_finance: Course = {
  id: 'renewable-energy-finance', slug: 'renewable-energy-finance', title: 'Renewable Energy Finance',
  description: 'A comprehensive cat-themed guide to Renewable Energy Finance. Learn how to analyze and invest in this sector.',
  category: 'ESG', difficulty: 'intermediate', icon: '📘', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'renewable-energy-finance-1', slug: 'renewable-energy-finance-1', title: 'Sector Overview', description: 'Understanding the Renewable Energy Finance sector.',
      commands: ['help'], steps: [
        { instruction: 'Explore the Renewable Energy Finance sector and its key players.' },
    ...
    { id: 'renewable-energy-finance-2', slug: 'renewable-energy-finance-2', title: 'Key Metrics', description: 'Important metrics for Renewable Energy Finance.',
      commands: ['help'], steps: [
    ...
    { id: 'renewable-energy-finance-3', slug: 'renewable-energy-finance-3', title: 'Investment Strategies', description: 'Strategies for Renewable Energy Finance investing.',
      commands: ['help'], steps: [
