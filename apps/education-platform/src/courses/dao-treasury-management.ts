...
export const dao_treasury_management: Course = {
  id: 'dao-treasury-management', slug: 'dao-treasury-management', title: 'DAO Treasury Management',
  description: 'A cat-friendly guide to DAO Treasury Management. The cat explores Web3 one paw at a time.',
  category: 'Web3', difficulty: 'advanced', icon: '🔗', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'dao-treasury-management-1', slug: 'dao-treasury-management-1', title: 'Core Concepts', description: 'Understanding DAO Treasury Management.', commands: ['defi protocols'], steps: [
      { instruction: 'Learn the fundamentals of DAO Treasury Management.' },
    ...
    { id: 'dao-treasury-management-2', slug: 'dao-treasury-management-2', title: 'Practical Applications', description: 'Using DAO Treasury Management in practice.', commands: ['gas 1'], steps: [
    ...
    { id: 'dao-treasury-management-3', slug: 'dao-treasury-management-3', title: 'Security Best Practices', description: 'Staying safe.', commands: ['gas 1'], steps: [
