...
export const defi_yield_farming: Course = {
  id: 'defi-yield-farming', slug: 'defi-yield-farming', title: 'DeFi Yield Farming',
  description: 'A cat-friendly guide to DeFi Yield Farming. The cat explores Web3 one paw at a time.',
  category: 'DeFi', difficulty: 'advanced', icon: '🔗', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'defi-yield-farming-1', slug: 'defi-yield-farming-1', title: 'Core Concepts', description: 'Understanding DeFi Yield Farming.', commands: ['defi protocols'], steps: [
      { instruction: 'Learn the fundamentals of DeFi Yield Farming.' },
    ...
    { id: 'defi-yield-farming-2', slug: 'defi-yield-farming-2', title: 'Practical Applications', description: 'Using DeFi Yield Farming in practice.', commands: ['gas 1'], steps: [
    ...
    { id: 'defi-yield-farming-3', slug: 'defi-yield-farming-3', title: 'Security Best Practices', description: 'Staying safe.', commands: ['gas 1'], steps: [
