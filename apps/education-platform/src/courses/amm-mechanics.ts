...
export const amm_mechanics: Course = {
  id: 'amm-mechanics', slug: 'amm-mechanics', title: 'AMM Mechanics',
  description: 'A cat-friendly guide to AMM Mechanics. The cat explores Web3 one paw at a time.',
  category: 'DeFi', difficulty: 'advanced', icon: '🔗', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'amm-mechanics-1', slug: 'amm-mechanics-1', title: 'Core Concepts', description: 'Understanding AMM Mechanics.', commands: ['defi protocols'], steps: [
      { instruction: 'Learn the fundamentals of AMM Mechanics.' },
    ...
    { id: 'amm-mechanics-2', slug: 'amm-mechanics-2', title: 'Practical Applications', description: 'Using AMM Mechanics in practice.', commands: ['gas 1'], steps: [
    ...
    { id: 'amm-mechanics-3', slug: 'amm-mechanics-3', title: 'Security Best Practices', description: 'Staying safe.', commands: ['gas 1'], steps: [
