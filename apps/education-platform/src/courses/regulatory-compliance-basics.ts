...
export const regulatory_compliance_basics: Course = {
  id: 'regulatory-compliance-basics', slug: 'regulatory-compliance-basics', title: 'Regulatory Compliance Basics',
  description: 'A cat-guided professional development course on Regulatory Compliance Basics. Sharpen your skills.',
  category: 'Regulation', difficulty: 'intermediate', icon: '💼', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'regulatory-compliance-basics-1', slug: 'regulatory-compliance-basics-1', title: 'Fundamentals', description: 'Core principles of Regulatory Compliance Basics.', commands: ['help'], steps: [
      { instruction: 'Learn the fundamentals of Regulatory Compliance Basics.' },
    ...
    { id: 'regulatory-compliance-basics-2', slug: 'regulatory-compliance-basics-2', title: 'Practical Application', description: 'Applying these skills.', commands: ['help'], steps: [
    ...
    { id: 'regulatory-compliance-basics-3', slug: 'regulatory-compliance-basics-3', title: 'Mastery', description: 'Advanced techniques.', commands: ['help'], steps: [
      { instruction: 'Master advanced techniques in Regulatory Compliance Basics.' },
