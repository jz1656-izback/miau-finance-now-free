...
export const india_financial_markets: Course = {
  id: 'india-financial-markets', slug: 'india-financial-markets', title: 'India Financial Markets',
  description: 'Explore India Financial Markets — the cat travels the world one market at a time.',
  category: 'Global Markets', difficulty: 'intermediate', icon: '🌍', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'india-financial-markets-1', slug: 'india-financial-markets-1', title: 'Market Overview', description: 'Understanding India Financial Markets.', commands: ['global'], steps: [
      { instruction: 'Explore India Financial Markets using the global markets command.' },
    ...
    { id: 'india-financial-markets-2', slug: 'india-financial-markets-2', title: 'Trading Mechanics', description: 'How to trade in this market.', commands: ['global'], steps: [
    ...
    { id: 'india-financial-markets-3', slug: 'india-financial-markets-3', title: 'Investment Opportunities', description: 'Opportunities in India Financial Markets.', commands: ['help'], steps: [
