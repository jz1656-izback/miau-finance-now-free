...
export const financial_writing_reporting: Course = {
  id: 'financial-writing-reporting', slug: 'financial-writing-reporting', title: 'Financial Writing & Reporting',
  description: 'A cat-guided professional development course on Financial Writing & Reporting. Sharpen your skills.',
  category: 'Career Development', difficulty: 'intermediate', icon: '💼', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'financial-writing-reporting-1', slug: 'financial-writing-reporting-1', title: 'Fundamentals', description: 'Core principles of Financial Writing & Reporting.', commands: ['help'], steps: [
      { instruction: 'Learn the fundamentals of Financial Writing & Reporting.' },
    ...
    { id: 'financial-writing-reporting-2', slug: 'financial-writing-reporting-2', title: 'Practical Application', description: 'Applying these skills.', commands: ['help'], steps: [
    ...
    { id: 'financial-writing-reporting-3', slug: 'financial-writing-reporting-3', title: 'Mastery', description: 'Advanced techniques.', commands: ['help'], steps: [
      { instruction: 'Master advanced techniques in Financial Writing & Reporting.' },
