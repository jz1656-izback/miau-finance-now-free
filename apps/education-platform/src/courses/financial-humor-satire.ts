...
export const financial_humor_satire: Course = {
  id: 'financial-humor-satire', slug: 'financial-humor-satire', title: 'Financial Humor & Satire',
  description: 'A comprehensive cat-themed course on Financial Humor & Satire.',
  category: 'Literacy', difficulty: 'intermediate', icon: '📘', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'financial-humor-satire-1', slug: 'financial-humor-satire-1', title: 'Overview', description: 'Introduction to Financial Humor & Satire.', commands: ['help'],
      steps: [{ instruction: 'Learn the fundamentals of Financial Humor & Satire.' },
    ...
    { id: 'financial-humor-satire-2', slug: 'financial-humor-satire-2', title: 'Core Concepts', description: 'Key ideas.', commands: ['help'],
      steps: [{ instruction: 'Explore the core concepts of Financial Humor & Satire.' },
    ...
    { id: 'financial-humor-satire-3', slug: 'financial-humor-satire-3', title: 'Practical Use', description: 'Real-world application.', commands: ['help'],
