...
export const defense_aerospace_finance: Course = {
  id: 'defense-aerospace-finance', slug: 'defense-aerospace-finance', title: 'Defense & Aerospace Finance',
  description: 'A comprehensive cat-themed guide to Defense & Aerospace Finance. Learn how to analyze and invest in this sector.',
  category: 'Industry Analysis', difficulty: 'intermediate', icon: '📘', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'defense-aerospace-finance-1', slug: 'defense-aerospace-finance-1', title: 'Sector Overview', description: 'Understanding the Defense & Aerospace Finance sector.',
      commands: ['help'], steps: [
        { instruction: 'Explore the Defense & Aerospace Finance sector and its key players.' },
    ...
    { id: 'defense-aerospace-finance-2', slug: 'defense-aerospace-finance-2', title: 'Key Metrics', description: 'Important metrics for Defense & Aerospace Finance.',
      commands: ['help'], steps: [
    ...
    { id: 'defense-aerospace-finance-3', slug: 'defense-aerospace-finance-3', title: 'Investment Strategies', description: 'Strategies for Defense & Aerospace Finance investing.',
      commands: ['help'], steps: [
