...
export const european_markets: Course = {
  id: 'european-markets', slug: 'european-markets', title: 'European Markets',
  description: 'Explore European Markets — the cat travels the world one market at a time.',
  category: 'Global Markets', difficulty: 'intermediate', icon: '🌍', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'european-markets-1', slug: 'european-markets-1', title: 'Market Overview', description: 'Understanding European Markets.', commands: ['global'], steps: [
      { instruction: 'Explore European Markets using the global markets command.' },
    ...
    { id: 'european-markets-2', slug: 'european-markets-2', title: 'Trading Mechanics', description: 'How to trade in this market.', commands: ['global'], steps: [
    ...
    { id: 'european-markets-3', slug: 'european-markets-3', title: 'Investment Opportunities', description: 'Opportunities in European Markets.', commands: ['help'], steps: [
