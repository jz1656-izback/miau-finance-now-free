...
export const nordic_markets: Course = {
  id: 'nordic-markets', slug: 'nordic-markets', title: 'Nordic Markets',
  description: 'Explore Nordic Markets — the cat travels the world one market at a time.',
  category: 'Global Markets', difficulty: 'intermediate', icon: '🌍', lessonCount: 3, estimatedMinutes: 20,
  lessons: [
    { id: 'nordic-markets-1', slug: 'nordic-markets-1', title: 'Market Overview', description: 'Understanding Nordic Markets.', commands: ['global'], steps: [
      { instruction: 'Explore Nordic Markets using the global markets command.' },
    ...
    { id: 'nordic-markets-2', slug: 'nordic-markets-2', title: 'Trading Mechanics', description: 'How to trade in this market.', commands: ['global'], steps: [
    ...
    { id: 'nordic-markets-3', slug: 'nordic-markets-3', title: 'Investment Opportunities', description: 'Opportunities in Nordic Markets.', commands: ['help'], steps: [
